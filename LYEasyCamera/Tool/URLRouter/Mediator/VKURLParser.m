...
-(BOOL)parseURL:(NSURL *)url toAction:(NSString *__autoreleasing*)action toParamDic:(NSDictionary *__autoreleasing*)params;
{
    ...
    if (actionName && actionName.length > 0 &&
        ([LYMediatorAction instancesRespondToSelector:NSSelectorFromString(actionName)] ||
         [LYMediatorAction instancesRespondToSelector:NSSelectorFromString(actionNamePlus)])) {
